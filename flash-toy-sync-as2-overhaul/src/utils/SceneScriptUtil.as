...
class utils.SceneScriptUtil {
	 ...
	 * @return
	 */
	public function getInterpolatedPosition(_positions : Array, _index : Number) : Number {
		...
		if (positionAfter == null) {
			var returnValue; trace("Error: " + "Unable to get interpolated position, there are no valid positions"); return returnValue;
		}
