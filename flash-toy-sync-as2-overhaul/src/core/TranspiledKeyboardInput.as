 ...
 */
class core.TranspiledKeyboardInput {
	...
	public function TranspiledKeyboardInput(_object : MovieClip, _keyDownHandler : Function, _keyUpHandler : Function) {
		pressedKeys = [];
		...
		inputListener.onKeyUp = function() : Void {
			...
			var pressedKeyIndex : Number = TranspiledArrayFunctions.indexOf(self.pressedKeys, Key.getCode());
	...
	public function isKeyPressed(_key : Number) : Boolean {
		return TranspiledArrayFunctions.indexOf(pressedKeys, _key) >= 0;
	}
}